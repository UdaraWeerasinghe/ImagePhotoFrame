...
$customerResult=$reportObj->getCustomerByTimeAndAmount($startingDate, $endindDate);
//echo $customerResult;
...
$html.='<h3 style="text-align:center">Customer total amount between '
        .$minAmount.' and '.$maxAmount.'('.$_POST["starting_date"].' to '.$_POST["end_date"].')</h3><hr>';
...
while ($cRow=$customerResult->fetch_assoc()) {
    ...
    $html.='<td style="text-align:right">'."Rs.".number_format($cRow['totalAmount'],2).'</td>
      </tr>'; 
}
$html.='</table>';
