...
<html>
    <head>
        ...
        $deliveryResult=$deliveryObj->getReadyForDelivery();
        ...
        <div class="container-fluid m-0 p-0" style="width: 100%;">
            ...
            <div class="dashbord-body" id="dashbord-body">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="#">Ready for Delivery</a>
                  </li>
                  <li class="nav-item">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-warning btn-sm" 
                                            onclick="startDelivery('<?php echo base64_encode($dRow["order_id"]);?>','<?php echo $dRow["customer_fName"]." ".$dRow["customer_lName"]?>')">
                                        Start Delivery
                                    </button>
                                </td>
                            </tr>
...
<div class="modal" id="sendMail">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <form id="mailSend" method="post" action="../controller/delivery-controller.php?status=sendCustomerMail">
...
//            dataTable for customer tbl
         ...
         buttons: [
          ...
          function sendMail(email,name){
            var url="../controller/delivery-controller.php?status=CustomerMail";
        ...
        function viewOrder(orderId){  //load contend for view modal
            ...
            function startDelivery(orderId,name){
                Swal.fire({
                  title: 'Are you sure?',
                  text: "You want to start delivery "+name+"'s order",
                  icon: 'warning',
                  ...
                  if (result.isConfirmed) {
                    window.location = '../controller/delivery-controller.php?status=startDelivery&orderId=' + orderId;
                  }
                });
            }
