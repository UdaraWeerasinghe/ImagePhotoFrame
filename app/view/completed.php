...
<html>
    <head>
        ...
        include '../model/module-model.php';
            ...
            $orderObj=new Order();
            $allOrder=$orderObj->getAllCompletedOrders();
            if(isset($_GET["alert"])){
        ?>
    ...
    <body>
        ...
        <div style="flex-wrap: wrap; display: flex;">
            ...
            <div class="dashbord-body" id="dashbord-body" style="flex: 70%; height: 800px; padding: 10px;">
                ...
                <ul class="nav nav-tabs" style="margin-bottom: 10px;">
                  ...
                  <li class="nav-item">
                      <a class="nav-link active" href="completed.php">Waiting For Payment</a>
                  </li>
                  <li class="nav-item">
                            ...
                            <tr>
                               ...
                               echo date('G:i:s', $timestamp);
                                ...
                                <td>
                                    ...
                                    <a type="button" class="btn btn-sm btn-warning" href="../controller/order-controller.php?status=startDeliveryProcess&oId=<?php echo base64_encode($order_row["order_id"]); ?>">Start Delivery</a>
                                </td>
                            </tr>
                 <?php } ?>
                        </tbody>
        ...
        <script type="text/javascript">
         ...
         $(document).ready(function() {
            ...
            icon: 'success',
            title: 'Successfull',
            text: 'Order Delivery Process Started',
