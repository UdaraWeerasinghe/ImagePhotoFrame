...
<html>
    <head>
        ...
        include '../model/module-model.php';
            ...
            $materialResult=$reportObj->getMaterils();
        ...
        <div class="container-fluid m-0 p-0" style="width: 100%;">
            ...
            <div class="dashbord-body" id="dashbord-body">
                ...
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                      <a class="nav-link active" href="supplier-report.php">Supplier Reports</a>
                  </li>
                  <li class="nav-item">
...
<div class="modal" id="custome_repo-modal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div>
          <form id="customReport" method="post" action="../view/reports-custom-supplier.php">
      <!-- Modal body -->
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <label>Supply Materials</label>
                                <select name="mat_id" class="form-control">
                                    <option value="">Any Material</option>
                                    <?php
                                while ($mRow=$materialResult->fetch_assoc()){
                                    ?>
                                <option value="<?php echo $mRow['material_id']?>"><?php echo $mRow['material_name']?></option>
                                    <?php
                                }
                                    ?>
                                </select>
