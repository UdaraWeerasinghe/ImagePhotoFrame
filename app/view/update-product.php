        ...
        <div style="flex-wrap: wrap; display: flex;">
            ...
            <div class="dashbord-body" id="dashbord-body" style="padding: 10px;">
                <div class="container-fluid">
                    ...
                    <div class="col-sm-8">
                        <h3 style="text-align: center; margin-bottom: 20px;">Update Product</h3>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" value="<?php echo $price["product_price"]; ?>" min="0" onkeypress="return isNumberKey(event)" name="<?php echo $tRow['size_id']; ?>" class="form-control" required>
                                                <input name="sizeId[]" value="" hidden>
                                            </div>
